...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \end{minipage}\\
            \vspace{0.8cm}
            {\fontsize{14.4}{18}\selectfont Actividad 3: \\ \vspace{0.3cm} \textbf{Análisis de regresión lineal}}
            ...
            \begin{table}[h]
                ...
                \begin{tabular}{l l} % 'l' izquierda, 'c' centro, 'c' centro
                    ...
                    Presenta: &  \textbullet\ Cortés Cortés Bryan Yael\\
                    %\addlinespace[0.3cm] % Espacio extra entre filas sin líneas
                       &  \textbullet\ Pineda Ortega Daniel\\
                       &  \textbullet\ Rodríguez Mérida Diego\\
                       &  \textbullet\ Romero Minchaca Esteban\\
                       &  \textbullet\ Sánchez Santos Denisse Alejandra\\
                       &  \textbullet\ Suriano Granados Duncan Zuriel
            ...
            \hspace{5.5cm} Fecha de entrega: 09 de abril de 2026 
